...
3. **Resolution**: We aim to provide a resolution or a public advisory within **7-14 business days**, depending on the complexity of the issue.
...
- **Database Security**: Regularly audit your Supabase **Row Level Security (RLS)** policies to ensure only authorized investigators can access sensitive case data.
